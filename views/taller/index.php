    ...
    <tbody>
      ...
      ?>
        <tr>
          ...
          <td>
            <ul>
              <i class="btn btn-success bi bi-pencil"><a href="taller.php?accion=modify&id_taller=<?php echo $dato['id_taller']; ?>" style="color: black;">Modificar</a></i>
              <i class="btn btn-danger bi bi-trash-fill"><a href="taller.php?accion=delete&id_taller=<?php echo $dato['id_taller']; ?>" style="color: black;">Eliminar</a></i>
            </ul>
          </td>
